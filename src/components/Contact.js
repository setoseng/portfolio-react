...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (name.length === 0 || email.length === 0 || message.length === 0) {
      ...
      emailjs
        .send(
          "service_ugohkkr", // service id
          "template_irxrxrs", // template id
          mailData,
          "KI-i8qulleNqs8pi6" // public api
        )
        .then(
          (response) => {
            setError(false);
              ...
              <ul>
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>
                      <a href="mailto:example@gmail.com">setoseng@gmail.com</a>
                    </span>
                  </div>
                </li>
                <li>
